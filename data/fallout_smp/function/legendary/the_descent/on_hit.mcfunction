...
execute unless entity @s[tag=dep_descent_attacker] if items entity @s weapon.mainhand minecraft:netherite_sword[custom_data~{fallout_smp:{legendary_weapon:"the_descent"}}] run scoreboard players set @s dep.descent_cd 0
