#> fallout_smp:legendary/pale_blade/sensor_spawn_19

summon minecraft:interaction ~ ~ ~ {Tags:["dep_pale_sensor","dep_pale_sensor_19","dep_pale_sensor_new"],width:0.68f,height:0.68f,response:0b}
...
execute if entity @e[type=interaction,tag=dep_pale_sensor_new,limit=1] run tellraw @a[tag=convention.debug] {"text":"[Pale Blade] sensor_spawn_19","color":"gray"}
