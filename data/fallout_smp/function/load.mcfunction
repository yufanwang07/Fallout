...
scoreboard objectives add dep.descent_cd_used dummy
...
scoreboard objectives add dep.descent_hp_before dummy
scoreboard objectives add dep.descent_hp_after dummy
...
scoreboard players set #dep.2 dep.config 2
scoreboard players set #dep.3 dep.config 3
scoreboard players set #dep.4 dep.config 4
scoreboard players set #dep.5 dep.config 5
scoreboard players set #dep.12 dep.config 12
scoreboard players set #dep.700 dep.config 700
